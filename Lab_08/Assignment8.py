...
table = pd.pivot_table(data=df_employees, values='Salary', index=['Type', 'Department'], aggfunc={'Salary': ["sum", "mean", "count"]})
table.columns = ['Employee Count','Total Salary', 'Average Salary']
